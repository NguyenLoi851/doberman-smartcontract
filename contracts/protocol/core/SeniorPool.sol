...
contract SeniorPool is BaseUpgradeablePausable, ISeniorPool {
        ...
        returns (uint256 depositShares)
    {
        ...
        require(
            sharesWithinLimit(potentialNewTotalShares),
            "Deposit would put the senior pool over the total limit."
        );
    ...
    function redeem(
        ...
        (uint256 interestRedeemed, uint256 principalRedeemed) = pool
            .withdrawMax(tokenId);
